...
class Prep:
    ...
    def removeframe(self):
        ...
        PrepStore.baseSelection(self.inventory, ["R", [self.getItem, self.getVolume, self.getQuantity, self.getExpiry,
                                                       self.getContainer]])
    ...
    def checkExpiry(self):
        ...
        PrepStore.baseSelection(self.inventory, "C")
        print("It works")
